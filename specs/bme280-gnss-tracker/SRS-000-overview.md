...
Añadir un sensor **BME280** por **I²C** a la app de geolocalización LR1110 para que cada ciclo
envíe por LoRaWAN **datos ambientales** (temperatura, humedad, presión) **y** un **paquete GNSS**.

## Actores y hardware

- **MCU:** STM32L476 (Nucleo-L476RG).
- **Radio:** LR1110 (EVK).
- **Sensor:** Bosch **BME280**, dirección I²C `0x76` (SDO a GND) o `0x77` (SDO a VDD).
...
- **RESTR-5 — Sin dependencias externas:** no añadir librerías de terceros; el driver BME280 se
...
- Gestión de energía avanzada del sensor más allá del modo forzado del BME280.
