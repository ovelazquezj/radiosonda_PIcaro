...
#   Uso:  export APP=<tu-app-id>;  ./scripts/subscribe.sh          (todos los devices de la app)
#         export APP=<tu-app-id>;  ./scripts/subscribe.sh <devEui> (solo el DevEUI que use el host)
set -euo pipefail
