...
| Device profile **EU868** | *(lo crea `provision.sh eu868` al vuelo — p. ej. `Demos-LR1110-EU868` / `Tracker-BMP280-EU868`; o créalo tú, ver [`REGISTRO_API`](../demos/REGISTRO_API_CHIRPSTACK.md))* |
