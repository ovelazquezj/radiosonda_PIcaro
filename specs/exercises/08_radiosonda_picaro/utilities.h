...
//
// >>> RADIOSONDA PICARO: placa seleccionada = T-Beam clasica (ESP32) con radio SX1276 <<<
// Si tu T-Beam trae otro chip de radio, comenta la linea SX1276 y descomenta la que
// corresponda (SX1262 o SX1278). Solo debe quedar UNA linea activa en todo este archivo.
